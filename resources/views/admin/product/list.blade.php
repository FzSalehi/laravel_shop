        ...
        <div class="row mb-2 mt-4">
          <div class="col-12">
            <h1 class="m-0 text-dark">
                ...
                محصولات
                <a class="btn btn-primary float-left text-white py-2 px-4" href="{{ route('product.create') }}">افزودن محصول جدید</a>
            </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                              ...
                              @if (count($products) > 0)
                                    ...
                                    <tr>
                                        <td colspan="9" class="text-center">
                                            <div class="btn btn-warning">{{__('product.is empty')}}</div>
                                        </td>
                                    </tr>
                              @endif

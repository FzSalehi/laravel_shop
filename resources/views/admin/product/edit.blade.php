        ...
        <div class="row mb-2 mt-4">
          <div class="col-12">
            <h1 class="m-0 text-dark">
                ...
                محصولات / ویرایش
                <a class="btn btn-primary float-left text-white py-2 px-4" href="{{ route('product.index') }}">بازگشت به صفحه محصولات</a>
            </h1>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                              ...
                              <div class="row">
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <img src="{{asset("/storage//".$product->thumbnail_url)}}" alt="" width="100px" height="100px">
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <img src="{{asset("/storage//".$product->demo_url)}}" alt="" width="100px" height="100px">
                                      </div>
                                  </div>
                                  <div class="col-md-4">
                                      <div class="form-group">
                                          ...
                                          <a href="{{ route('product.source.download',$product->id) }}" class="btn btn-primary float-left">دانلود سورس</a>
                                      </div>
                                  </div>
